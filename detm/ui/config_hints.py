...
We keep user-facing hints in `detm/presets/config.default.py` as `///` comments.
This module extracts those hints so the Tk UI can display tooltips without
duplicating text in code.
"""
