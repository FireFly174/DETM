...
def serialize_level_policy(policy: Any) -> dict[str, Any]:
    return {
        ...
        "refinement_capacity_saturation_band": float(max(0.0, policy.refinement_capacity_saturation_band)),
        "refinement_capacity_min_signals": int(max(1, policy.refinement_capacity_min_signals)),
        "refinement_capacity_autoclamp_enabled": bool(policy.refinement_capacity_autoclamp_enabled),
        ...
        "refinement_operator_torsion_threshold": float(max(0.0, policy.refinement_operator_torsion_threshold)),
        "refinement_operator_torsion_guard_enabled": bool(policy.refinement_operator_torsion_guard_enabled),
        "refinement_operator_history_limit": int(max(1, policy.refinement_operator_history_limit)),
        "anti_goodhart_enabled": bool(policy.anti_goodhart_enabled),
        "anti_goodhart_target_signal": str(policy.anti_goodhart_target_signal),
        "anti_goodhart_min_target_delta": float(max(0.0, policy.anti_goodhart_min_target_delta)),
        "anti_goodhart_min_degraded_signals": int(max(1, policy.anti_goodhart_min_degraded_signals)),
        "anti_goodhart_degradation_epsilon": float(max(0.0, policy.anti_goodhart_degradation_epsilon)),
        "anti_goodhart_policy_reaction_enabled": bool(policy.anti_goodhart_policy_reaction_enabled),
        "anti_goodhart_prefer_runtime_profile": str(policy.anti_goodhart_prefer_runtime_profile),
