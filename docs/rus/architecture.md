...
Сводка целевой архитектуры (north star): `docs/rus/30_architecture/target_architecture_synthesis.md`.
...
1) на каждом `GlobalTick` (тик `L0`) применяет все due‑влияния **без продвижения времени**
2) выполняет ровно **1** тик `L0`
