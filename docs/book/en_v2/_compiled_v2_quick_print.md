...
7. Level summaries (L0-L5), practical version
8. Navigation cheat sheet (S-T-C)
9. Invariants and tests
10. Terms
11. Index (terms, themes, operators)
12. Case registry
...
This file is a compressed action-oriented synthesis.
Use it when you need routing and first operators quickly.
...
- First operators are usually coarse and protective:
  `L0-C1` (pause), `L0-C4` (scope reduction), `L0-C6` (feedback restoration), `L0-C2` (refusal normalization).
...
_stats: chars=66106, words=9174, pages=36.7 (rough)_
