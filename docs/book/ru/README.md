...
Чтобы не дублировать объяснения между книгой и DETM:
- единая выжимка концептов: `docs/rus/90_notes/book_concepts_single_source.md`
- модель обучения DETM: `docs/rus/90_notes/learning_model_detm.md`
- протокол метрик/readout/anti-Goodhart: `docs/rus/90_notes/readout_protocol_and_antigoodhart.md`
