"""Fabric handshake subscriber wiring for headless runs."""
...
from detm_app.runtime.subscribers import FabricHandshakeRecorder


def attach_fabric_handshake_subscriber(
    *,
    session: DetmSession,
    config: DETMConfig,
    seed: int,
    ...
    fabric_acks_policy = storage_policy(config=config, level_name=level_name, artifact="fabric_acks")
    fabric_ack_envelopes_policy = storage_policy(
        config=config, level_name=level_name, artifact="fabric_ack_envelopes"
    )
    fabric_delivery_acks_policy = storage_policy(config=config, level_name=level_name, artifact="fabric_delivery_acks")
    fabric_dead_letters_policy = storage_policy(config=config, level_name=level_name, artifact="fabric_dead_letters")
    fabric_quorum_report_policy = storage_policy(config=config, level_name=level_name, artifact="fabric_quorum_report")
...
__all__ = ["attach_fabric_handshake_subscriber"]
